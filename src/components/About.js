...
const About = () => {
    return (
        <div className='fs-5'>
            ...
            <p>
                In addition to structured plotting, our longterm goal is to train an AI to assist in the brainstorming process. The nature of AI transformer models is that they write like a "pantser". We hope Story Ghost combines the best of both the plotter and pantser styles to help you quickly formulate structurally sound and creative stories.
            </p>
            <p>
