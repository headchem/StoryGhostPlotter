...
public class FunAndGames : ISequence
{
    ...
    public string EventsDescription { get { return "The Hero proactively attempts to resolve the problem while exploring this new upside-down world. The Hero meets new characters who are the antithesis of everything they knew in their old status quo life."; } }
    public string ContextDescription { get { return "Focus on the B Story subplot (typically the love interest) and heavily infuse the Dramatic Question into the dialogue and events. This is the fun part of the story."; } }
