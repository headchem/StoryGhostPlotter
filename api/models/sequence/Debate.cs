...
public class Debate : ISequence
{
    ...
    public string ContextDescription { get { return "The Hero is in shock and they doubt if they have what it takes to tackle the Problem. The Hero's personal flaws are further exposed, causing the audience to also doubt the Hero's ability to succeed."; } }
