...
public class HistoricalPrehistoric : IAppealTerm
{
    ...
    public string PromptLabel { get { return "prehistoric times"; } }
    ...
    public string Description { get { return "These stories illuminate the times before there was a written record of history. The dawn of humanity offers many venues for speculations about what it means to be human, how one might survive in a \"primitive\" setting."; } }
